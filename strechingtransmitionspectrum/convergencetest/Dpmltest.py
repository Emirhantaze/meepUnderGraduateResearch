...
while iscontinue:
    ...
    if isfirstrun:
        """
        plt.plot(wvls,transmittance_ratio , color="r",label=f'dpml: {dpml}')
        plt.legend()
        plt.show()
        """
        isfirstrun = False
        ...
        #plt.plot(wvls,oldtransmittiance , color="black",label=f'dpml: {olddpml}')
        #plt.plot(wvls,transmittance_ratio , color="r",label=f'dpml: {dpml}')
        oldtransmittiance=transmittance_ratio
        ...
        #plt.show()
        pass
print(f"Convergence Test is finished dpml should be: {olddpml}")