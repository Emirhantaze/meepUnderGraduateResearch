...
apsorbtions = np.divide(innerside_with_flux-(otherside_with_flux+lightside_with_flux),otherside_without_flux)#+np.divide(lightside_with_flux,otherside_without_flux)
...
plt.plot(wavelengths,apsorbtions[np.arange(500,750)],'b',label='absorbtion 60')
plt.plot(wavelengths,apsorbtions[np.arange(750,1000)],'y',label='absorbtion 80')
plt.plot(wavelengths,apsorbtions[np.arange(1000,1250)],'p',label='absorbtion 100')
