...
bnds = opt.Bounds([-np.inf,-10,1e-10,1e-10,-np.inf,1e-10,1e-10,-np.inf
                    ,1e-10,1e-10,-np.inf,1e-10,1e-10,-np.inf,1e-10,1e-10,-np.inf,1e-10,44e-2],
...
a = opt.minimize(fun1, guess,method = "L-BFGS-B",bounds=bnds,options={'maxiter':1e6}, tol = 0)
print(a)
print(a.fun)
